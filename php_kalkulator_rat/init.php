...
function &getSmarty(){
	...
	if (!isset($smarty)){
		...
		$smarty->setTemplateDir(array(
			'one' => getConf()->root_path.'/app/calc/views',
			'two' => getConf()->root_path.'/app/calc/views/templates',
			'three' => getConf()->root_path.'/app/security/views',
			'four' => getConf()->root_path.'/app/security/views/templates'
		));
	}
	return $smarty;
}
