...
<head>
	...
	<meta name="description" content="{$page_description|default:"Podstawowy opis storny"}">
...
<div id="app_top" class="header">
    <div class="home-menu pure-menu pure-menu-open pure-menu-horizontal pure-menu-fixed">
        <a class="pure-menu-heading" href="">{$page_title|default:"Tytuł nagłówek"}</a>
        <ul>
            <li class="pure-menu-selected"><a href="#app_top">Góra strony</a></li>
            <li><a href="#app_content">Idź do formularza</a></li>
            <li class="home-logout"><a href="{$app_url}/app/security/logout.php">Wyloguj</a></li>
        </ul>
    </div>
</div>
...
<div class="splash-container">
    <div class="splash">
        <h1 class="splash-head">{$page_header|default:"Cośtam cośtam"}</h1>
        <p class="splash-subhead">
             {$page_description|default:"Domyślny opis"}
        </p>
    </div>
</div>
